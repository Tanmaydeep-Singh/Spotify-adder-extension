    ...
    const getSpotifyID = async () => {
      ...
      if (videoTitle) {
        const { data } = await axios.get(
          `https://api.spotify.com/v1/search?q=track:${videoTitle}%20artist:${channel}&type=track`,
          header
        );
        console.log(
          `https://api.spotify.com/v1/search?q=track:${videoTitle}%20artist:${channel}&type=track`
      ...
      <div className="form-control ">
        ...
        <div>
          ...
          (
            ...
            <button className="btn bg-[#E87121] text-[#000000] hover:bg-[#E87121]">
              {" "}
              Searching for track
            </button>
          </>
